...
import com.suntide_20210418.dimensiontech.loot.expectation.RandomStateExecutor1201;
...
class RandomStateExecutor1201Test {
    ...
    void repeatedRollsUseThePreviousRollContinuationState() {
        ...
        var result =
                RandomStateExecutor1201.repeat(
                        3,
                        initial,
                        state -> {
                            var draw = state.nextInt(137);
                            return new RandomStateExecutor1201.StepResult<>(
