...
class MythicMinerExpectationMathTest {
    ...
    void effectiveExpectationMatchesFractionalMachineOutput() {
        ...
        double draws = MythicMinerExpectationMath.expectedDraws(parallel, 8, quantityFactor);
        ...
        assertEquals(
                8.992D,
                MythicMinerExpectationMath.expectedItemCount(2.0D, 5.0D, draws),
                0.000_001D);
        assertEquals(
                13.488D,
                MythicMinerExpectationMath.expectedItemCount(3.0D, 5.0D, draws),
                0.000_001D);
    }

    @Test
    void quantityFactorUsesTheSameHundredthTruncationAsProduction() {
        assertEquals(33, MythicMinerExpectationMath.quantityFactorHundredths(1.0D, 3.0D));
        assertEquals(100, MythicMinerExpectationMath.quantityFactorHundredths(1.0D, 0.0D));
        assertEquals(0, MythicMinerExpectationMath.quantityFactorHundredths(0.0D, 3.0D));
    }
}
