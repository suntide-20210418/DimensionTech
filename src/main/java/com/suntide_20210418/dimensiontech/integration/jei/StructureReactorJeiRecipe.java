...
/**
 * One displayable reactor conversion: a recipe read on one branch. It carries only registries-free
 ...
 */
public record StructureReactorJeiRecipe(
        ResourceLocation id,
        ...
        int targetDepth,
        ReactorFormula.Bounds bounds,
        int maxExtraFragments) {

    public StructureReactorJeiRecipe {
