 ...
 * off-screen by {@link MythicMinerMenu}, and drawn by the page renderers — so their geometry belongs
 * with the pages that own it, in {@code MythicMinerInfoLayout}. What remains is what the menu and
