...
/** Shared pixel geometry for the Mythic Crucible texture, menu and screen. */
public final class MythicCrucibleLayout {
    ...
    public static final ResourceLocation TEXTURE =
            ResourceLocationHelper.modLoc("guis/mythic_crucible.png");
