...
public final class OutputFaceConfigScreen extends Screen {
    ...
    private ItemStack adjacentBlock(Direction d) {
        ...
        var block = minecraft.level.getBlockState(menu.getBlockPos().relative(world)).getBlock();
