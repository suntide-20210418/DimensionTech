 ...
 *
 * <p>Pressing the key (default V) with a chest marker in hand sends the block under the crosshair
 * to the server, which validates it as a loot-table container and marks it. The client uses its own
