...
public final class ModBlocks {
    ...
    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(Registries.BLOCK, DimensionTechMod.MOD_ID);
    public static final DeferredHolder<Block, Block> STRUCTURE_DATA_OPERATOR =
            BLOCKS.register(
                    "structure_data_operator",
                    () ->
                            new StructureDataOperatorBlock(
                                    BlockBehaviour.Properties.of().strength(4.0F)));
    public static final DeferredHolder<Block, Block> STRUCTURE_REACTOR =
            BLOCKS.register(
                    "structure_reactor",
                    () -> new StructureReactorBlock(BlockBehaviour.Properties.of().strength(4.0F)));

    public static final DeferredHolder<Block, Block> TIER_1_STRUCTURE_MINER =
            BLOCKS.register(
    ...
    public static final DeferredHolder<Block, Block> TIER_2_STRUCTURE_MINER =
            BLOCKS.register(
                    "tier_2_structure_miner",
                    () ->
                            new Tier2StructureMinerBlock(
                                    BlockBehaviour.Properties.of().strength(5.0F)));
    public static final DeferredHolder<Block, Block> TIER_3_STRUCTURE_MINER =
            BLOCKS.register(
                    "tier_3_structure_miner",
                    () ->
                            new Tier3StructureMinerBlock(
                                    BlockBehaviour.Properties.of().strength(5.0F)));
    public static final DeferredHolder<Block, Block> TIER_4_STRUCTURE_MINER =
            BLOCKS.register(
                    "tier_4_structure_miner",
                    () ->
                            new Tier4StructureMinerBlock(
                                    BlockBehaviour.Properties.of().strength(5.0F)));
    public static final DeferredHolder<Block, Block> TIER_5_STRUCTURE_MINER =
            BLOCKS.register(
                    "tier_5_structure_miner",
                    () ->
                            new Tier5StructureMinerBlock(
                                    BlockBehaviour.Properties.of().strength(5.0F)));
    public static final DeferredHolder<Block, Block> TIER_6_STRUCTURE_MINER =
            BLOCKS.register(
                    "tier_6_structure_miner",
                    () ->
                            new Tier6StructureMinerBlock(
                                    BlockBehaviour.Properties.of().strength(5.0F)));
    public static final DeferredHolder<Block, Block> STRUCTURE_MINER_CASING =
            BLOCKS.register(
    ...
    public static final DeferredHolder<Block, Block> STRUCTURE_MINER_GLASS =
            BLOCKS.register(
                    "structure_miner_glass",
                    () -> new Block(BlockBehaviour.Properties.of().strength(3.0F).noOcclusion()));
    public static final DeferredHolder<Block, Block> UPGRADE_PARALLEL =
            upgrade("parallel", StructureMinerUpgradeBlock.Type.PARALLEL, 1);
    public static final DeferredHolder<Block, Block> UPGRADE_LUCK =
            upgrade("luck", StructureMinerUpgradeBlock.Type.LUCK, 1);
    public static final DeferredHolder<Block, Block> UPGRADE_ENERGY =
            upgrade("energy", StructureMinerUpgradeBlock.Type.ENERGY, 1);
    public static final DeferredHolder<Block, Block> UPGRADE_EFFICIENCY =
            upgrade("efficiency", StructureMinerUpgradeBlock.Type.EFFICIENCY, 1);
    public static final DeferredHolder<Block, Block> UPGRADE_AGGREGATE =
            upgrade("aggregate", StructureMinerUpgradeBlock.Type.AGGREGATE, 1);
    public static final DeferredHolder<Block, Block>[] UPGRADE_PARALLEL_TIERS =
            upgradeTiers("parallel", StructureMinerUpgradeBlock.Type.PARALLEL, UPGRADE_PARALLEL);
    public static final DeferredHolder<Block, Block>[] UPGRADE_LUCK_TIERS =
            upgradeTiers("luck", StructureMinerUpgradeBlock.Type.LUCK, UPGRADE_LUCK);
    public static final DeferredHolder<Block, Block>[] UPGRADE_ENERGY_TIERS =
            upgradeTiers("energy", StructureMinerUpgradeBlock.Type.ENERGY, UPGRADE_ENERGY);
    public static final DeferredHolder<Block, Block>[] UPGRADE_EFFICIENCY_TIERS =
            upgradeTiers(
                    "efficiency", StructureMinerUpgradeBlock.Type.EFFICIENCY, UPGRADE_EFFICIENCY);
    public static final DeferredHolder<Block, Block>[] UPGRADE_AGGREGATE_TIERS =
            upgradeTiers("aggregate", StructureMinerUpgradeBlock.Type.AGGREGATE, UPGRADE_AGGREGATE);

    private static DeferredHolder<Block, Block> upgrade(
    ...
    private static DeferredHolder<Block, Block>[] upgradeTiers(
            String name,
            StructureMinerUpgradeBlock.Type type,
            DeferredHolder<Block, Block> tierOne) {
        DeferredHolder<Block, Block>[] tiers = new DeferredHolder[6];
        tiers[0] = tierOne;
