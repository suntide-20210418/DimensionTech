...
public final class StructureMinerUpgradeBlock extends Block {
    public enum Type {
        NONE,
        PARALLEL,
        LUCK,
    ...
    public StructureMinerUpgradeBlock(BlockBehaviour.Properties properties, Type type, int tier) {
        super(properties);
        this.type = type;
            ...
            case NONE ->
                    tooltip.add(
                            Component.translatable(
                                            "tooltip.dimension_tech.structure_miner.upgrade.none")
                                    .withStyle(ChatFormatting.DARK_GRAY));
        }
    }

    private ModConfigs.StructureMinerUpgradeTierConfig upgradeConfig() {
    ...
    private static void addEfficiencyTooltip(
            List<Component> tooltip, ModConfigs.StructureMinerUpgradeTierConfig config) {
        addPercentTooltip(
                tooltip,
                "tooltip.dimension_tech.structure_miner.upgrade.efficiency",
    ...
    private static void addParallelTooltip(
        ...
        addPercentTooltip(
                tooltip,
                "tooltip.dimension_tech.structure_miner.upgrade.parallel",
    ...
    private static void addLuckTooltip(
        ...
        addPercentTooltip(
                tooltip,
                "tooltip.dimension_tech.structure_miner.upgrade.luck",
