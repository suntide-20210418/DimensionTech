...
public final class Tier6StructureMinerBlockEntity extends BaseMinerBlockEntity {
    public Tier6StructureMinerBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.TIER_6_STRUCTURE_MINER.get(), pos, state);
    }
