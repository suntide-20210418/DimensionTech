...
public final class StructureMinerMarkerAnalysisCacheGameTests {
    private StructureMinerMarkerAnalysisCacheGameTests() {}
    ...
    private static CacheFixture fixture(GameTestHelper helper) {
        ...
        List<CompletableFuture<StructureValueCalculator.StructureValue>> futures =
                new ArrayList<>();
        StructureMinerMarkerAnalysisCache cache =
                new StructureMinerMarkerAnalysisCache(
                        inventory,
                        () -> {
