...
/**
 * Packs a crucible state sequence into the int words carried by the container data channel. The
 ...
 */
public final class CrucibleSequenceTelemetry {
    ...
    private CrucibleSequenceTelemetry() {}
