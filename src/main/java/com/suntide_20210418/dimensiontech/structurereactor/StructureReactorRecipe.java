...
/**
 * Immutable V1 reactor recipe. A recipe has one DSL, except tier five's explicit A/B pair.
 *
 * @param <S> the supplied stack type, an {@code ItemStack} in production
 */
public final class StructureReactorRecipe<S> {
    /** Kept as the recipe-facing alias of the formula's unrewarded settlement time. */
    public static final int BASE_TIME_TICKS = ReactorFormula.NATURAL_TIME_TICKS;
