...
public class ModZhcnLangProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("screen.dimension_tech.mythic_crucible.stage.stabilize", "稳定");
        add("screen.dimension_tech.mythic_crucible.input", "输入精华");
        add("screen.dimension_tech.mythic_crucible.output", "输出精华");
        add("screen.dimension_tech.mythic_crucible.ritual", "仪式流程");
        add("screen.dimension_tech.mythic_crucible.current", "当前：%s %s/%s tick");
        add("screen.dimension_tech.mythic_crucible.waiting", "等待输入流体 / 碎片");
        add("screen.dimension_tech.mythic_crucible.fragments", "碎片槽");
