...
public class ModZhcnLangProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("screen.dimension_tech.mythic_miner.progress", "运行进度");
        ...
        add("screen.dimension_tech.mythic_miner.current_parallel", "当前并行");
        add("screen.dimension_tech.mythic_miner.extra_parallel", "额外并行");
        add("screen.dimension_tech.mythic_miner.extra_items", "额外物品");
        add("screen.dimension_tech.mythic_miner.output", "输出状态");
